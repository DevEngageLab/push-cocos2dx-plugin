...
- (void)p_addNotification {
  ...
  [defaultCenter addObserver:self
                    selector:@selector(networkDidSetup:)
                        name:kMTCNetworkDidSetupNotification
                      object:nil];
  [defaultCenter addObserver:self
  ...
  [defaultCenter addObserver:self
                    selector:@selector(networkDidRegister:)
                        name:kMTCNetworkDidRegisterNotification
                      object:nil];
  [defaultCenter addObserver:self
  ...
  [defaultCenter addObserver:self
                    selector:@selector(serviceError:)
                        name:kMTCServiceErrorNotification
                      object:nil];
}
 ...
 */
void MTPushBridge::registerCallbackFunction(
 ...
 */
void MTPushBridge::registerSetupCallbackFunction(
    void *p_handle, APNetworkDidSetup_callback setup_callback) {
  callbackController.setupCallback = setup_callback;
  setupHandle = p_handle;
};
 ...
 */
void MTPushBridge::registerCloseCallbackFunction(
 ...
 */
void MTPushBridge::registerRegisterCallbackFunction(
 ...
 */
void MTPushBridge::registerLoginCallbackFunction(
 ...
 */
void MTPushBridge::registerReceiveMessageCallbackFunction(
...
// */
//void MTPushBridge::setAliasAndTags(void *p_handle, const char *alias,
//                                   set<string> *tags,
...
//}
//
//void MTPushBridge::setTags(void *p_handle, set<string> *tags,
//                           APTagAliasCallback callback) {
//  if (callbackController) {
//    setAliasTagsHandle = p_handle;
...
//}
//
//void MTPushBridge::setAlias(void *p_handle, const char *alias,
//                            APTagAliasCallback callback) {
//  if (callbackController) {
//    setAliasTagsHandle = p_handle;
...
// *
// */
//bool MTPushBridge::filterValidTags(c_tags tags, set<string> *result) {
//  if (result == NULL) {
 ...
 *  get RegistionID
 */
const char *MTPushBridge::registrationID() {
    return [[MTPushService registrationID] UTF8String];
}
void MTPushBridge::setDebugMode(){
    [MTPushService setDebugMode];
}
void MTPushBridge::setLogOFF(){
